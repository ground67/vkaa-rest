...
const titoko = `https://vka-api.herokuapp.com/downloader/tiktoknowm?link=${url}`
const tikitoko = `https://vka-api.herokuapp.com/converter/tomp3?url=https://vka-api.herokuapp.com/downloader/tiktoknowm?link=${url}`
const obj = {
	videoInfo: {
		id: ingfo.id,
		desc: ingfo.text,
